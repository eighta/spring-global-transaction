 ...
 */
// TODO 08: Make RewardConfirmation serializable, and run the test. It will fail.
public class RewardConfirmation implements java.io.Serializable{
	...
	public String toString() {
		return String.format("Reward of %s applied to account %s. RewardConfirmation id is: %s",
				accountContribution.getAmount(), accountContribution.getAccountNumber(), confirmationNumber);
	}
