 ...
 */
// TODO 09: Make AccountContribution serializable, and run the test. It will fail.

public class AccountContribution implements java.io.Serializable{
	...
	public static class Distribution implements Serializable {
		...
		public boolean equals(Object o) {
			...
			return amount.equals(other.amount) && beneficiary.equals(other.beneficiary)
					&& percentage.equals(other.percentage) && totalSavings.equals(other.totalSavings);
		}

		@Override
		public int hashCode() {
			return amount.hashCode() + beneficiary.hashCode() + percentage.hashCode() + totalSavings.hashCode();
		}
	}
	...
	@Override
	public int hashCode() {
		return accountNumber.hashCode() + amount.hashCode() + distributions.hashCode();
	}

	@Override
	public boolean equals(Object o) {
		if (!(o instanceof AccountContribution)) {
			return false;
		}
		AccountContribution other = (AccountContribution) o;
		// value objects are equal if their attributes are equal
		return accountNumber.equals(other.accountNumber) && amount.equals(other.amount)
